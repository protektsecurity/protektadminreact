...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: DEHHLA8X1Dnw/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: H_Jc_6SUdGUB/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: hRaYI4Gf2_22/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__fAu4I)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__tPkCn)}
              role={"img"}
            />
          ),
